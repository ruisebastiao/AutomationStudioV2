...
#include "automationstudiocore/visuallogbasemodel.h"
...
class AUTOMATIONSTUDIO_CORE_EXPORT VisualLogFilter : public VisualLogBaseModel, public QQmlParserStatus{

    Q_OBJECT
    Q_INTERFACES(QQmlParserStatus)
    Q_PROPERTY(as::VisualLogBaseModel* source     READ source     WRITE setSource NOTIFY sourceChanged)
...
public:
    ...
    as::VisualLogBaseModel* source() const;
    QString tag() const;
    QJSValue search() const;
    bool isIndexing() const;

    void setSource(as::VisualLogBaseModel* source);
...
private:
    ...
    as::VisualLogBaseModel* m_source;
    QString                 m_tag;
