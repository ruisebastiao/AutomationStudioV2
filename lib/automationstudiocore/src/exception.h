...
#include "automationstudiocore/stacktrace.h"
#include "automationstudiocore/automationstudiocoreglobal.h"

namespace as{

class AUTOMATIONSTUDIO_CORE_EXPORT Exception : public std::exception{
...
#define CREATE_EXCEPTION(_type, _message, _code) \
    as::Exception::create<_type>((_message), (_code), __FILE__, __LINE__, __FUNCTION__, as::StackTrace::capture())
