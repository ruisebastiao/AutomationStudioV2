...
#include "automationstudiocore/incubationcontroller.h"
...
void Engine::throwError(const as::Exception *e, QObject *object){
    ...
    if ( dynamic_cast<const as::FatalException*>(e) != nullptr ){
        jsError.setProperty("type", "FatalException");
    } else if ( dynamic_cast<const as::InputException*>(e) != nullptr ){
