...
#include "automationstudiocore/typeinfo.h"
...
class AUTOMATIONSTUDIO_CORE_EXPORT FatalException : public as::Exception{

public:
    FatalException(const QString& message, int code = 0): as::Exception(message, code){}
    virtual ~FatalException(){}
};

class AUTOMATIONSTUDIO_CORE_EXPORT InputException : public as::Exception{
public:
    InputException(const QString& message, int code = 0) : as::Exception(message, code){}
    virtual ~InputException(){}
};


class AUTOMATIONSTUDIO_CORE_EXPORT Engine : public QObject{
