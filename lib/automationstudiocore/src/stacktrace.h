...
class AUTOMATIONSTUDIO_CORE_EXPORT StackFrame{
...
AUTOMATIONSTUDIO_CORE_EXPORT VisualLog &operator <<(VisualLog &vl, const StackFrame &value);

// StackTrace
// ----------

class AUTOMATIONSTUDIO_CORE_EXPORT StackTrace{
...
AUTOMATIONSTUDIO_CORE_EXPORT VisualLog &operator <<(VisualLog &vl, const StackTrace &value);
