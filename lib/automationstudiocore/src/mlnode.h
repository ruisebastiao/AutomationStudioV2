...
class AUTOMATIONSTUDIO_CORE_EXPORT MLOutOfRanceException: public as::Exception{
public:
    MLOutOfRanceException(const QString& message = "", int code = 0) : as::Exception(message, code){}
};

class AUTOMATIONSTUDIO_CORE_EXPORT InvalidMLTypeException: public as::Exception{
public:
    InvalidMLTypeException(const QString& message = "", int code = 0) : as::Exception(message, code){}
};

class AUTOMATIONSTUDIO_CORE_EXPORT TypeNotSerializableException: public as::Exception{
public:
    TypeNotSerializableException(const QString& message = "", int code = 0) : as::Exception(message, code){}
};

// MLNode
// ------

class AUTOMATIONSTUDIO_CORE_EXPORT MLNode{
...
public:
    ...
    class AUTOMATIONSTUDIO_CORE_EXPORT BytesType{
    ...
    class AUTOMATIONSTUDIO_CORE_EXPORT IteratorValue{
    public:
    ...
    class AUTOMATIONSTUDIO_CORE_EXPORT Iterator{
    ...
    class AUTOMATIONSTUDIO_CORE_EXPORT ConstIteratorValue{
    public:
    ...
    class AUTOMATIONSTUDIO_CORE_EXPORT ConstIterator{
    public:
        friend class MLNode;
...
AUTOMATIONSTUDIO_CORE_EXPORT VisualLog &operator <<(VisualLog &vl, const MLNode &value);
