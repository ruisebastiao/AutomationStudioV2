...
as::Engine*   PluginContext::m_engine   = 0;
as::Settings* PluginContext::m_settings = 0;
...
void PluginContext::initFromEngine(QQmlEngine *engine){
    ...
    m_engine   = qobject_cast<as::Engine*>(automationstudio->property("engine").value<QObject*>());
