...
win32:CONFIG(release, debug|release): linkExternalLib(opencv/lib,opencv,_world341)
else:win32:CONFIG(debug, debug|release): linkExternalLib(opencv/lib,opencv,_world341d)
else:unix: LIBS += -lopencv_core -lopencv_imgproc -lopencv_imgcodecs -L/usr/local/lib/
