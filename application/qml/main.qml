...
ApplicationWindow {
    ...
    property User loggedUser: appsettings.currentUser
    ...
    Connections{
        ...
        onLoadedChanged: {
            if(loaded){
                ...
                appsettings.currentUser=appsettings.users.getItemAt(0);
                ...
                RowLayout{
                    ...
                    Item{
                        ...
                        RowLayout{
                            ...
                            spacing: 3
                            Item{
                                visible: appsettings.currentUser
                    ...
                    RowLayout{
                        ...
                        Item {
                            ...
                            Label{
                                ...
                                text:appsettings.currentUser?appsettings.currentUser.name:""
                            }
                        }
                    }
    ...
    Component{
        ...
        GUI.DockingLayout{
            ...
            id:maindocking
            //            anchors.fill: parent
            visible:appsettings.basefileLoaded && appsettings.loaded
            ...
            Rectangle{
                ...
                anchors.fill: parent
                visible:appsettings.basefileLoaded && appsettings.loaded==false
                TextField{
                    id:source_path_id
                    anchors.centerIn: parent
                    width: 450;

                    text: appsettings.source
                    onTextChanged: {
