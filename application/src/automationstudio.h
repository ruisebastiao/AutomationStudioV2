...
class AutomationStudio : public QObject{
    ...
    Q_PROPERTY(as::Engine*         engine         READ engine   CONSTANT)
...
public:
    ...
    static AutomationStudio::Ptr create(int argc, const char* const argv[], QObject* parent = nullptr);
...
private:
    AutomationStudio(QObject* parent = nullptr);
...
inline Engine *AutomationStudio::engine(){
    return m_engine;
}
